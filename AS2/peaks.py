...
plot_fitness_iteration('fitness_iteration_sa_peaks.png', sa_curve,
                       "Peaks - Simulated Annealing: schedule: {}, init_temp: {}".format(schedule.__class__.__name__, init_temp))
...
plot_fitness_iteration('fitness_iteration_ga_peaks.png',gen_curve,
                       "Peaks - Genetic Alg: mutation_prob: {}, pop_size: {}".format(mutation_prob, pop_size))
...
plot_fitness_iteration('fitness_iteration_mimic_peaks.png',mimic_curve,
                       "Peaks - Mimic: Population Size: {}, Keep Percent: {}".format(pop_size, keep_pct))
...
plot_fitness_iteration('fitness_iteration_rhc_peaks.png',rhc_curve,
                       "Peaks - Randomized Hill Climbing: restarts: {}".format(restarts))
...
for name, curve in all_curves.items():
    ...
    plt.legend(loc="best")
plt.savefig('peaks_combined.png')
